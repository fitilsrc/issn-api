...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "libs/shared/src/generated/client",
    "shared/src/generated/client",
  ]
...
path.join(process.cwd(), "libs/shared/src/generated/client/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "libs/shared/src/generated/client/schema.prisma")
